    ...
    <form class="splash-container" method="POST" action="{{ route('register') }}">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="mb-1" style="text-align:center;">CREATE AN ACCOUNT</h3>
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        <input id="password-confirm" type="password" class="form-control form-control-lg" name="password_confirmation" autocomplete="new-password" placeholder="Comfirm Password">
                    </div>
